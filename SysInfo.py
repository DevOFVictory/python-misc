...
print("External IPv4: " + requests.get('http://ip.42.pl/raw').text)
print("External IPv6: " + requests.get('https://ident.me').text)
print("Used server: speedtest.net")
print("Testing Download Speed...")
print("Current Download Speed: " + str(adjust_size(st.download())) + "/s")
print("Testing Upload Speed...")
print("Current Upload Speed: " + str(adjust_size(st.upload())) + "/s")
servernames = []
st.get_servers(servernames)
print("Current Ping: " + str(int(st.results.ping)) + "ms")
